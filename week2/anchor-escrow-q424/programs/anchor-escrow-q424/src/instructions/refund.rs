...
pub struct Refund<'info> {
    ...
    #[account(
        mut,
        close = maker,
        has_one = mint_a, //verfie que c'est le bon jeton 
        has_one = maker, // verifie que c'est le bons maker 
...
impl<'info> Refund<'info> {
    pub fn refund_and_close_vault(&mut self) -> Result<()> {
        ...
        // transfer les jetons du vault vers le maker 
